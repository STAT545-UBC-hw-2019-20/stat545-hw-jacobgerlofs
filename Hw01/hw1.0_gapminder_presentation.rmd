...
```{r}
datatable(as_tibble(gapminder::gapminder), extensions = "AutoFill")
```
...
## Let's Take a Look at Canada! | Life Expectancies
...
## Let's Take a Look at Canada! (cont) | GDP
...
## Let's Take a Look at Canada! (cont) | Canadian GDP over Time, Graphed
...
## Let's Take a Look at Canada! (cont) | Canadian Life Expectancy over Time, graphed
